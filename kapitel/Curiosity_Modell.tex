...
Da sich der Fokus allerdings haupttsächlich auf den \emph{internen} Belohnungswert \(r_{int}(t)\) konzentriert, kann man im Folgenden zum einfacheren Verständnis stets von \(r_{ext}(t) = 0\) ausgehen.
