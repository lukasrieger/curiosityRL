...
David Jonathan Müller hat die Abschnitte~\ref{sec:intro}, \ref{sec:related} und~\ref{subsec:heur} verfasst. Lukas Johannes Rieger hat die Abschnitte~\ref{subsec:ml} und \ref{sec:results} verfasst. Den Abschnitt~\ref{sec:conclusion} haben beide Autoren gemeinsam verfasst. (In einer wissenschaftlichen Arbeit ohne Prüfungszweck stünde hier eine Danksagung!)
}% <-- mind this closing brace!
